...
The amount of users is 100, and average for edges is 10. Logically it would be anywhere between `(8 * 100) or (2 * 100)` depending on what is added to each individual user.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?
Without writing an algorithm to count each individual unit, however from cursory glance of a test, it seems that the average is anywhere close to 60% connection, with a separation of around 4 to 5 connections.
